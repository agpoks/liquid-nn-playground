...
one visual language instead of five ad-hoc drawings.
"""
...
LINEAR = "#0891b2"     # teal: an nn.Linear (or masked-Linear) affine map
NONLIN = "#4f46e5"     # indigo: an elementwise nonlinearity / gate
STATE = "#be123c"      # rose: the recurrent/hidden state itself
OTHER = "#64748b"      # slate-grey: pooling, norm, misc
